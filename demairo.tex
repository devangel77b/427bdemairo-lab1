...
Results were initially visualized in Python using the \texttt{numpy}, \texttt{scipy}, and \texttt{matplotlib} libraries \cite{numpy,scipy,matplotlib}. Subsequent statistical analysis \cite{starnes:2015:practice} was perfomed in R \cite{R} using the \texttt{ggplot2} and \texttt{dplyr} libraries \cite{ggplot2,dplyr}
